...
const serviceLayer = require("../Service/serrvice") 
...
exports.addUser = async (req, res) => {
  try {
    ...
    const dataToSend = {userID,pointsEarned,pointsRedeemed,transactionDate };
      const result = await serviceLayer.addUser(dataToSend);
